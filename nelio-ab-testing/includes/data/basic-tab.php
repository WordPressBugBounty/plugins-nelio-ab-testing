...
return array(
	...
	array(
		...
		'name' => 'nelio-ai',
		'ui'   => fn() => array(
			'label' => _x( 'Recommendation Engine', 'text', 'nelio-ab-testing' ),
		),
	),
	...
	array(
		...
		'ui'      => fn() => array(
			'label' => 'Nelio AI',
			'desc'  => _x( 'Use AI to generate test suggestions', 'command', 'nelio-ab-testing' ),
		),
	),
	...
	array(
		...
		'ui'      => fn() => array(
			'label' => _x( 'Traffic Analysis', 'text', 'nelio-ab-testing' ),
