...
require_once __DIR__ . '/jet-form-builder/index.php';
require_once __DIR__ . '/leadpages/index.php';
require_once __DIR__ . '/metform/index.php';
require_once __DIR__ . '/mw-wp-form/index.php';
...
require_once __DIR__ . '/sureforms/index.php';
