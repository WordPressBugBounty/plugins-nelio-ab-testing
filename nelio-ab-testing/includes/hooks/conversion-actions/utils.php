 ...
 * @return TAttributes
 */
function sanitize_conversion_action_attributes_pre_save( $attributes, $action, $experiment = null ) {
	/**
	 * Filters a conversion action’s attributes.
	 *
	 * @param TAttributes                       $attributes Conversion action’s attributes.
	 ...
	 * @since 8.5.0
	*/
	return apply_filters( 'nab_sanitize_conversion_action_attributes_pre_save', $attributes, $action, $experiment );
}
 ...
 * @return TConversion_Action_Scope
 */
function sanitize_conversion_action_scope_pre_save( $scope, $action ) {
	/**
	 * Filters a conversion action’s scope.
	 *
	 * @param TConversion_Action_Scope $scope  Conversion action’s scope.
	 ...
	 * @since 8.5.0
	 */
	return apply_filters( 'nab_sanitize_conversion_action_scope_pre_save', $scope, $action );
}
